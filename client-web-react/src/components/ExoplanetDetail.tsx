...
export default function ExoplanetDetail({ planet, onClose }: ExoplanetDetailProps) {
  return (
        ...
        <div className="detail-stats">
          ...
          <div className="detail-stat">
            ...
            <div>
              ...
              <div className="stat-value">
                {planet.radius_earth != null ? `${planet.radius_earth.toFixed(3)}× Earth` : 'N/A'}
              </div>
            </div>
          </div>
          <div className="detail-stat">
            ...
            <div>
              ...
              <div className="stat-value">
                {planet.mass_earth != null ? `${planet.mass_earth.toFixed(3)}× Earth` : 'N/A'}
              </div>
            </div>
          </div>
          <div className="detail-stat">
          ...
          <div className="detail-stat">
            ...
            <div>
              ...
              <div className="stat-value">{planet.constellation || 'N/A'}</div>
            </div>
          </div>
